...
export const toolBackdrops: Record<string, BackdropIcon[]> = {
  ...
  "loan-prepayment-calculator": [
    { icon: TrendingDown, className: "-right-16 -top-16 h-[400px] w-[400px] rotate-6 opacity-[0.04]" },
    { icon: Banknote, className: "-left-20 bottom-10 h-[260px] w-[260px] -rotate-6 opacity-[0.03]" },
  ],
  "compound-interest-calculator": [
    { icon: Sigma, className: "-right-16 -top-16 h-[400px] w-[400px] rotate-6 opacity-[0.04]" },
    { icon: LineChart, className: "-left-20 bottom-10 h-[260px] w-[260px] -rotate-6 opacity-[0.03]" },
  ],
  "fd-calculator": [
    { icon: PiggyBank, className: "-right-16 -top-16 h-[400px] w-[400px] rotate-6 opacity-[0.04]" },
    { icon: Landmark, className: "-left-20 bottom-10 h-[260px] w-[260px] -rotate-6 opacity-[0.03]" },
  ],
  "rd-calculator": [
    { icon: Repeat, className: "-right-16 -top-16 h-[400px] w-[400px] rotate-6 opacity-[0.04]" },
    { icon: CalendarClock, className: "-left-20 bottom-10 h-[260px] w-[260px] -rotate-6 opacity-[0.03]" },
  ],
  "ppf-calculator": [
    { icon: ShieldCheck, className: "-right-16 -top-16 h-[400px] w-[400px] rotate-6 opacity-[0.04]" },
    { icon: Landmark, className: "-left-20 bottom-10 h-[260px] w-[260px] -rotate-6 opacity-[0.03]" },
  ],
  "goal-sip-calculator": [
    { icon: Target, className: "-right-16 -top-16 h-[400px] w-[400px] rotate-6 opacity-[0.045]" },
    { icon: TrendingUp, className: "-left-20 bottom-10 h-[260px] w-[260px] -rotate-6 opacity-[0.03]" },
  ],
  "percentage-calculator": [
    { icon: PercentCircle, className: "-right-16 -top-16 h-[400px] w-[400px] rotate-6 opacity-[0.04]" },
    { icon: Divide, className: "-left-20 bottom-10 h-[260px] w-[260px] -rotate-6 opacity-[0.03]" },
  ],
  "unit-converter": [
  ...
  "qr-code-generator": [
    { icon: QrCode, className: "-right-16 -top-16 h-[400px] w-[400px] rotate-6 opacity-[0.04]" },
    { icon: ScanLine, className: "-left-20 bottom-10 h-[260px] w-[260px] -rotate-6 opacity-[0.03]" },
  ],
  "timezone-converter": [
    { icon: Globe2, className: "-right-16 -top-16 h-[400px] w-[400px] rotate-6 opacity-[0.04]" },
    { icon: MapPin, className: "-left-20 bottom-10 h-[260px] w-[260px] -rotate-6 opacity-[0.03]" },
  ],
  "countdown-timer": [
    { icon: Timer, className: "-right-16 -top-16 h-[400px] w-[400px] rotate-6 opacity-[0.045]" },
    { icon: Hourglass, className: "-left-20 bottom-10 h-[260px] w-[260px] -rotate-6 opacity-[0.03]" },
  ],
  "age-calculator": [
